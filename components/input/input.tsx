const PayPalInput = () => {
    return (
        <div className="flex flex-col">
          ...
          <input id="newPassword" type="password" className="p-4 border-2 border-gray-400 rounded-lg px-4 placeholder:text-xl focus:outline-none focus:border-blue-600 mt-4" placeholder="New password" required/>        
